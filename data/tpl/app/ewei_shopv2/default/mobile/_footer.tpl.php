...
<script>var imgs = document.getElementsByTagName('img');for(var i=0, len=imgs.length; i < len; i++){imgs[i].onerror = function() {if (!this.getAttribute('check-src') && (this.src.indexOf('http://') > -1 || this.src.indexOf('https://') > -1)) {this.src = this.src.indexOf('http://10.7.48.32/attachment/') == -1 ? this.src.replace('http://renren-ningchao.oss-cn-shanghai.aliyuncs.com/', 'http://10.7.48.32/attachment/') : this.src.replace('http://10.7.48.32/attachment/', 'http://renren-ningchao.oss-cn-shanghai.aliyuncs.com/');this.setAttribute('check-src', true);}}}</script></body>
</html>
