...
<div class="page-content">
    ...
    <div class="page-table-header">
        ...
        <?php  if($status ==1 ) { ?>
        <div class="btn-group">
            <button class="btn btn-default btn-sm  btn-operation" type="button" data-toggle='batch-remove' data-confirm="确认要发货吗?"  data-href="<?php  echo webUrl('order/list/send')?>">批量发货</button>
        </div>
        <?php  } ?>
        <div class="btn-group">
