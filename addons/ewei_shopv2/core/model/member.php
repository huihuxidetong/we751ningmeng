...
class Member_EweiShopV2Model 
{
	...
	public function getLevel($openid) 
	{
		...
		return array( "levelname" => (empty($_S["shop"]["levelname"]) ? "普通会员" : $_S["shop"]["levelname"]),"level"=>($_S["shop"]["level"]), "discount" => (empty($_S["shop"]["leveldiscount"]) ? 10 : $_S["shop"]["leveldiscount"]) );
	}
