...
class List_EweiShopV2Page extends MerchWebPage
{
	...
	public function send(){
		...
		{
			pdo_update('ewei_shop_order', array('status' => 2, 'sendtime' => $time), array('id' => $item['id'], 'uniacid' => $_W['uniacid'], 'merchid' => $_W['merchid']));
